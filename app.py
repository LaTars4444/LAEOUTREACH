...
def send_email():
    ...
    # Prioritize Request credentials, fallback to Environment Variables
    ...
    if not smtp_email or not smtp_password:
        return jsonify({"error": "Missing SMTP Credentials on Server"}), 400
    ...
    try:
        ...
        text = msg.as_string()
        server.sendmail(smtp_email, recipient, text)
        server.quit()
